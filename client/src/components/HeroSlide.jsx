  ...
  return (
    ...
    >
      <div>
        ...
        <button
          className="inline-block px-6 py-3 bg-blue-600 text-white font-semibold text-lg rounded-xl shadow-md hover:bg-blue-700 hover:scale-105 transition transform duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400"
        >
          Get Started
        </button>
      </div>
